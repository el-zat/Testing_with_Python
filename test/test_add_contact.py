...
def test_add_contact(app):
    ...
    contact = Contact(firstname="Ivan", lastname="Petrov", nickname="IvPet", company="SAP",
                      email="ivan.petrov@mail.com", homephone="45448", mobilephone="2416787",
                      workphone="478466", address="Longstreet,20 \n 58963 New York")
